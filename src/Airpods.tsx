    ...
    <Suspense fallback={null}>
      ...
      >
        <group position={[-11.308, 5.52, -5.535]} rotation={[0.427, 0.155, 2.453]}>
          <mesh geometry={nodes.airpods.geometry} material={materials['Paint_-_Enamel_Glossy_(White)']} castShadow receiveShadow />
        ...
        <group position={[14.864, 5.489, 7.139]} rotation={[0.468, -0.354, 0.897]}>
          <mesh geometry={nodes.airpods001.geometry} material={materials['Paint_-_Enamel_Glossy_(White)']} castShadow receiveShadow />
